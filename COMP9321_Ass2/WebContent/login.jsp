...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    <c:if test="${empty sessionScope.user_id}">
        <div class="container" id="login" style="display: none; padding-top: 2em;">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div id="register-form" role="form" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="username" id="reg_username" tabindex="1" class="form-control" placeholder="Username" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="nickName" id="nickName" tabindex="1" class="form-control" placeholder="Preferred Name" value="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="full_address" id="full_address" tabindex="1" class="form-control" placeholder="Mailing Address" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="number" name="yob" id="yob" tabindex="1" class="form-control" placeholder="Year of Birth" value="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" pattern="[0-9]{13,16}" name="CC" id="CC" tabindex="1" class="form-control" placeholder="Credit Card number" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="reg_password" id="reg_password" class="form-control" placeholder="Password" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="confirm-password" id="confirm-password" class="form-control" placeholder="Confirm Password" value=""> <span id="divCheckPasswordMatch"></span><br> <span id="validCC"></span><br> <span id="validFrm"></span>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-sm-offset-3">
    ...
    <c:if test="${not empty sessionScope.user_id}">
        <div class="container" id="login" style="display: none; padding-top: 2em;">
            <div class="span3 well">
                <center>
                    <a href="#aboutModal" data-toggle="modal" data-target="#myModal"><img src="https://openclipart.org/download/247320/abstract-user-flat-4.svg" name="aboutme" width="240" height="240" class="img-circle" /></a>
                    <h3>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center>
                                <img src="https://openclipart.org/download/247320/abstract-user-flat-4.svg" name="aboutme" width="240" height="240" border="0" class="img-circle"></a>
                                ...
                                <p class="text-left">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%=" " + session.getAttribute("yob")%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Address: </b></td>
                                            <td>
                                                <%=" " + session.getAttribute("full_address")%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><b>Credit Card No: </b></td>
                                            <td>
                                                <%=" XXXX XXXX XXXX " + session.getAttribute("cc").toString()
						.substring(session.getAttribute("cc").toString().length() - 4)%>
                                            </td>
                                        </tr>
                                    </table>
                                </p>
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> <i class="more-less glyphicon glyphicon-plus"></i> Ban/Activate User
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    <div id="login-form" role="form" style="display: block;">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="search_username" id="search_username" tabindex="1" class="form-control" placeholder="Username to Search" value="" onkeyup="setTimeout(searchInfoUser(),2000)">
                                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingTwo">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> <i class="more-less glyphicon glyphicon-plus"></i> Toggle Item Status
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <div id="login-form" role="form" style="display: block;">
                                        <div class="form-group">
                                            <input type="text" name="search_item" id="search_item" tabindex="1" class="form-control" placeholder="Item to Search" value="" onkeyup="setTimeout(searchInfoItem(),5000)">
                                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingThree">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> <i class="more-less glyphicon glyphicon-plus"></i> Customer Activity Log
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    <div id="login-form" role="form" style="display: block;">
                                        <div class="form-group">
                                            <input type="text" name="search_item_userAct" id="search_item_userAct" tabindex="1" class="form-control" placeholder="User to Search" value="" onkeyup="setTimeout(searchInfoUserAct(),5000)">
                                        </div>
